...
```
uv run cexi utils dds2png <INPUT_DDS> <OUTPUT_PNG>
```
...
```bash
uv run cexi utils dds2png exports/ui/50/titlwin.dds exports/ui/50/titlwin.png
uv run cexi utils dds2png exports/ui/50 exports/ui/50_png
```

### PNG to DDS

```
uv run cexi utils png2dds <INPUT_PNG> <OUTPUT_DDS> [OPTIONS]
```
...
```bash
uv run cexi utils png2dds edited.png rebuilt.dds --format dxt3
uv run cexi utils png2dds edited.png rebuilt.dds --match-source original.dds
uv run cexi utils png2dds exports/ui/1 exports/ui/1
uv run cexi utils png2dds exports/ui/50_png exports/ui/50_dds --match-source exports/ui/50
```
