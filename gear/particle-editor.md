...
# Example paths:
#   Linux (Ashita):  ln -s ~/.wine/drive_c/Games/CatsEyeXI/catseyexi-client game
#   Linux (native):  ln -s /opt/ffxi game
#   WSL:             ln -s /mnt/c/Games/CatsEyeXI/catseyexi-client game
...
from cexi.entity.xi_particle_patch import patch_particle_overrides, apply_effects_source
from cexi.zone.xi_inject import recolour_zone_dat
