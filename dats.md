...
tables. See `cexi gear json` and [gear/json.md](gear/json.md).
...
The `cexi model json` command scans all 4 ranges and will include these.
...
same model space as `cexi gear json` (see [gear/json.md](gear/json.md)).
