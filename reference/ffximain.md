...
| xiclient enum/name | English file_id | Resolved DAT | cexi interpretation |
|---|---:|---|---|
...
VTABLE byte equals that ROM index. This matches cexi's table model and explains why each file_id is a
