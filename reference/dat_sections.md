...
A **cutscene camera** is built from these same block-types, **byte-verified in cexi**
(`parse_camera_routes` in `src/cexi/event/xi_event.py`, decoded 2026-06-18 from a real
