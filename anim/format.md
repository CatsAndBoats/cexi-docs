...
| Path | Purpose |
|------|---------|
| `D:\cexi\catseyexi-client\Game\FINAL FANTASY XI\ROM\169\42.DAT` | Chocobo model (modified) |
| `D:\cexi\catseyexi-client\Game\FINAL FANTASY XI\ROM\169\42 - Copy.DAT` | Clean backup — always copy from here |
