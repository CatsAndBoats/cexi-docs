...
```
uv run cexi object set-placement <dat> <name> --pos X Y Z [--rot RX RY RZ] [--scale SX SY SZ]
```
...
```bash
uv run cexi object set-placement ROM/1/41 block03 --pos -8.8 0 -7.7 --rot 0 1.04 0
```
