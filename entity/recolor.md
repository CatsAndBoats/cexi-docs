...
cexi entity recolor "Crimson Tiger" --clone 308 --tint "#ff3300cc" --blend multiply

# Giant beetle — 4x scale, desaturated marble look
cexi entity recolor "Marble Beetle" --clone 408 --scale 4.0 --saturation -100 --lightness 30

# Tiny cyan wyrm
cexi entity recolor "Tiny Wyrm" --clone 783 --scale 0.5 --hue 180

# Shadow goblin (dark overlay)
cexi entity recolor "Shadow Goblin" --clone 291 --lightness -40 --tint "#330066aa" --blend overlay

# Holy tiger with white blur aura
cexi entity recolor "Holy Tiger" --clone 308 --blur "#ffffff,30,120"

# Purple aura wyrm
cexi entity recolor "Aura Wyrm" --clone 783 --hue 280 --blur "#8040cc,25,150"

# Orc with Ridill (gear weapon swap + joint remap)
cexi entity recolor "Orc Knight" --clone 617 --weapon "gear:HumeMale:main:259"

# Dual-wielding orc with recolored weapons
cexi entity recolor "Orc Dual" --clone 617 \
...
cexi entity recolor "Bighead Skel" --clone 564 --joint-scales "5-7:4.0"

# Dry run
cexi entity recolor "Test" --clone 308 --hue 120 --dry-run
```
...
cexi entity recolor "Holy Tiger" --clone 308 --blur "#ffffff"

# Purple aura, stronger distortion, larger radius
cexi entity recolor "Aura Wyrm" --clone 783 --blur "#8040cc,25,150"

# Subtle blue shimmer
cexi entity recolor "Frost Tiger" --clone 308 --blur "#c0d0ff,6,60"
```
...
# Red afterglow
cexi gear inject HumeMale main 259 --afterglow "#ff3300"

# Green afterglow with hue-shifted blade
cexi gear inject HumeMale main 259 --afterglow "#33ff66" --hue 120
...
# Big head + small arms
cexi entity recolor "Bobblehead" --clone 564 --joint-scales "5-7:3.0,8-33:0.5"

# Giant wyrm head
cexi entity recolor "Bighead Wyrm" --clone 783 --joint-scales "70-79:2.0"
```
...
cexi entity recolor "Club Skel" --clone 564 --weapon 569

# Gear model (auto-resolves DAT + remaps joint)
cexi entity recolor "Orc Knight" --clone 617 --weapon "gear:HumeMale:main:259"

# Explicit DAT path
cexi entity recolor "Custom Orc" --clone 617 --weapon "ROM/30/104.DAT"
```
...
cexi entity recolor "Orc Knight" --clone 617 \
  --weapon "gear:HumeMale:main:259" --weapon-hue 120

# Oversized purple Ragnarok
cexi entity recolor "Orc Warlord" --clone 617 \
...
cexi entity recolor "Orc Dualwield" --clone 617 \
  --weapon "gear:HumeMale:main:259" --weapon-hue 120 \
...
Find more with: `cexi gear json HumeMale main`
...
```bash
cexi entity recolor "Dark Warlord" --clone 617 \
...
Or use `cexi model json` to browse registered models.
