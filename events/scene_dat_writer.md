...
The compiler at [xi_compile.py](../../src/cexi/event/xi_compile.py) now emits the
...
Reading: [xi_event.parse_camera_routes](../../src/cexi/event/xi_event.py#L1043) /
[parse_effect_routines](../../src/cexi/event/xi_event.py#L1091). Writing:
[build_scene_resource](../../src/cexi/event/xi_compile.py) (`_build_evte` /
